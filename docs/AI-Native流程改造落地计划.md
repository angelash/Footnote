...
#### 验收清单
- [ ] `docs/00_charter/` 目录存在
- [ ] `docs/01_bibles/` 目录存在
- [ ] `docs/02_specs/systems/` 目录存在
- [ ] `docs/02_specs/ui/` 目录存在
- [ ] `docs/02_specs/pipelines/` 目录存在
- [ ] `docs/03_taskpacks/` 目录存在
- [ ] `docs/04_acceptance/qa_checklists/` 目录存在
- [ ] `docs/05_logs/` 目录存在
- [ ] `promptx/roles/` 目录存在
- [ ] `promptx/skills/` 目录存在
