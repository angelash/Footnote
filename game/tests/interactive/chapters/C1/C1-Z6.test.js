...
const TESTS = [
  // TC-C1Z6-01: 坍塌区域交互
  {
    ...
    expectedResults: {
      ...
      expectedLines: 5,
      dialogueContains: ['发生了什么', '不规则的凹陷', '边缘很整齐'],
      foreshadow: null,
      nextZone: null,
    },
  },
  ...
  // TC-C1Z6-02: 受灾住户交互
  {
    ...
    expectedResults: {
      ...
      expectedLines: 9,
      dialogueContains: ['我的房子', '没有声音，没有震动', '等"更正"'],
      foreshadow: null,
      nextZone: null,
    },
  },
  ...
  // TC-C1Z6-03: 通讯点交互（顾临通讯）
  {
    ...
    expectedResults: {
      ...
      expectedLines: 13,
      dialogueContains: ['你到现场了', '不需要人工干预', '你是来巡检的，不是来修复的'],
      foreshadow: null,
      nextZone: null,
    },
  },
  ...
  // TC-C1Z6-04: 碎片交互
  {
    ...
    expectedResults: {
      ...
      expectedLines: 4,
      dialogueContains: ['坍塌后留下的碎片', '边缘也很整齐', '被切割的'],
      foreshadow: null,
      nextZone: null,
    },
  },
