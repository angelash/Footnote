  ...
  tests: [
    ...
    // ========================================================================
    {
      ...
      expectedResults: {
        ...
        rDelta: 0,
        pDelta: 1, // 使用深度感知
        dialogueId: 'C2Z7_TRY_ENTER',
        expectedLines: 7,
        dialogueContains: ['试图触碰那个门影', '拒绝访问', '对象：不存在', '我看见了'],
        foreshadow: null,
        nextZone: null
      },
      branches: [
    ...
    // ========================================================================
    {
      ...
      expectedResults: {
        ...
        rDelta: 0,
        pDelta: 1,
        dialogueId: 'C2Z7_JUST_RECORD',
        expectedLines: 1,
        dialogueContains: ['先不轻举妄动……记下来再说'],
        foreshadow: null,
        nextZone: null
      },
      branches: [],
    ...
    // ========================================================================
    {
      ...
      expectedResults: {
        ...
        rDelta: 0,
        pDelta: 0,
        dialogueId: 'C2Z7_WALL_NORMAL',
        expectedLines: 3,
        dialogueContains: ['从表面看，这只是一面普通的墙', '看起来没什么特别的', '试试深度感知'],
        foreshadow: null,
        nextZone: null
      },
      branches: [],
    ...
    // ========================================================================
    {
      ...
      expectedResults: {
        ...
        rDelta: 0,
        pDelta: 0,
        dialogueId: 'C2Z7_SUBMIT_DONE',
        expectedLines: 4,
        dialogueContains: ['记录已提交', '你记录了一处"不存在"的空间', '但你知道它存在', '为什么系统否认'],
        foreshadow: null,
        nextZone: null
      },
      branches: [
    ...
    // ========================================================================
    {
      ...
      expectedResults: {
        ...
        rDelta: 0,
        pDelta: 0,
        dialogueId: 'C2Z7_BARRIER',
        expectedLines: 4,
        dialogueContains: ['封锁牌上写着', '前方区域结构异常', '禁止进入', '又是封锁区域'],
        foreshadow: null,
        nextZone: null
      },
      branches: [],
