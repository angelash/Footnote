...
const TESTS = [
  ...
  // ============================================
  {
    ...
    expectedResults: {
      ...
      nextZone: null,
      expectedLines: 5,
      dialogueContains: ['两种现实在交叠', '切换到版本V-A', '路更顺', '可归档'],
    },
  },
  ...
  // ============================================
  {
    ...
    expectedResults: {
      ...
      nextZone: null,
      expectedLines: 5,
      dialogueContains: ['两种现实在交叠', '切换到版本V-B', '路更绕', '解释成本上升'],
    },
  },
  ...
  // ============================================
  {
    ...
    expectedResults: {
      ...
      nextZone: null,
      expectedLines: 7,
      dialogueContains: ['纪念墙上写着', '名字', '抄下来', '无可用收益'],
    },
    critical: true,
    rValueTest: true,
  },
  ...
  // ============================================
  {
    ...
    expectedResults: {
      ...
      nextZone: null,
      expectedLines: 4,
      dialogueContains: ['差异标注点', '提交V-A', '版本已锁定', '可归档'],
    },
  },
  ...
  // ============================================
  {
    ...
    expectedResults: {
      ...
      nextZone: null,
      expectedLines: 4,
      dialogueContains: ['差异标注点', '提交V-B', '版本已锁定', '解释成本上升'],
    },
    critical: true,
    rValueTest: true,
  },
