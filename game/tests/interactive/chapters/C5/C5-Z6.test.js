...
const TESTS = [
  ...
  // ============================================
  {
    ...
    expectedResults: {
      ...
      nextZone: null,
      expectedLines: 10,
      dialogueContains: ['进入覆盖区', '条目：观测', '收敛：失败', '建议：降阶'],
    },
  },
  ...
  // ============================================
  {
    ...
    expectedResults: {
      ...
      nextZone: null,
      expectedLines: 4,
      dialogueContains: ['异常点①', '缺口', '点击标注', '字段补全失败'],
    },
  },
  ...
  // ============================================
  {
    ...
    expectedResults: {
      ...
      nextZone: null,
      expectedLines: 4,
      dialogueContains: ['异常点', '点击标注', '残差保留'],
    },
  },
  ...
  // ============================================
  {
    ...
    expectedResults: {
      ...
      nextZone: null,
      expectedLines: 6,
      dialogueContains: ['打开时间堆栈', '节点卡', '节点：◦◦', '无可回溯解释'],
    },
    critical: true,
    rValueTest: true,
    pValueTest: true,
  ...
  // ============================================
  {
    ...
    expectedResults: {
      ...
      nextZone: null,
      expectedLines: 6,
      dialogueContains: ['走向退出门', '收敛：失败', '穿过了一段'],
    },
    critical: true,
    pValueTest: true,
  },
